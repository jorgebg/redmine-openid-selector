...
var openid = {
	...
	init : function(input_id) {
		...
		//$('login-form').childElements()[0].submit = this.submit;
	...
	signin : function(box_id, onload) {
		...
		if (provider['label']) {
			...
			$('openid_input_area').innerHTML = '';
			if (!onload) {
				//$('login-form').childElements()[0].submit();
				this.submit();
			}
		}
	},
	...
	setOpenIdUrl : function(url) {
		...
		if (hidden != null) {
			...
			$('login-form').childElements()[0].insert('<input type="hidden" id="' + this.input_id + '" name="' + this.input_id + '" value="' + url + '"/>');
		}
	},
